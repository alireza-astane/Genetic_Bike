...
def absolute_parameters_fitness(ga_instance, chromosome):
    ...
    bike = Bike(
        decoded_params[0], decoded_params[1], 
        decoded_params[2], decoded_params[3], 
        decoded_params[4], decoded_params[5],
        decoded_params[6], decoded_params[7],
        decoded_params[8], decoded_params[9],
        decoded_params[10], decoded_params[11], 
        decoded_params[12], decoded_params[13], 
        decoded_params[14], decoded_params[15],
        decoded_params[16], decoded_params[17],
        decoded_params[18], decoded_params[19],
        decoded_params[20], decoded_params[21],
        decoded_params[22], decoded_params[23],
        decoded_params[24], decoded_params[25],
        decoded_params[26], decoded_params[27]
    )
...
def test_geneticAlgorithm():
    ...
    param_names = [
        ...
        "body_2_x", "body_2_y", "body_2_mass","k_spring_w1_w2","k_spring_w1_b1",
        "k_spring_w1_b2","k_spring_w2_b1","k_spring_w2_b2","k_spring_b1_b2",
        "loss_spring_w1_w2","loss_spring_w1_b1","loss_spring_w1_b2","loss_spring_w2_b1",
        "loss_spring_w2_b2","loss_spring_b1_b2"
    ]
